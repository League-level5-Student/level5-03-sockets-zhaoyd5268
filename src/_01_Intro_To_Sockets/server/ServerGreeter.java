	...
	public void run() {
		...
		// the previous step is true.
		 while (b == true) {
			 ...
			 try {
				 JOptionPane.showMessageDialog(null, "Attempting to secure a connection..."
				 		+ " \n Waiting for a client... ");
				 Socket s = ss.accept();
				 JOptionPane.showMessageDialog(null, "Successful connection secured.");
				 ...
				 JOptionPane.showMessageDialog(null, "Oops! We've experienced an error. Error type: SocketTimeout");
				 b = false;
			 } catch(IOException e) {
				 JOptionPane.showMessageDialog(null, "Oops! We've experienced an error. Error type: IO");			
				 b = false;
			 }
